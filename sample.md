...
Here's a link to [GitHub](https://github.com) and the [Markdown Guide](https://www.markdownguide.org/).

You can also use reference-style links: [MarkdownToWord Repository][repo].

[repo]: https://github.com/qiuhaotc/MarkdownToWord
...
You can combine different formatting options: **bold with `code`**, *italic with [links](https://example.com)*, and more.
